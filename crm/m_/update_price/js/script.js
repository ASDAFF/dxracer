$(function () {
    ...
    $('#update_all_price').on('click', function () {
        ...
        $.ajax({
                type: "post",
                url: "https://monarchshop.ru/scripts/update_price_by_update_price.php",
                async: false,
                success: function (data) {
                    alert(data+"KW");
                },
        ...
        // $.ajax({
        //         type: "post",
        //         url: "http://chasolink.ru/cron/update_price_by_zakaz1234.php",
        //         async: false,
        //         success: function (data) {
        //             alert(data+"CL");
        //         },
        //         error: function () {
        //             alert('Ошибка при обновлении цены CL')
        //         }
        //     }
        // );
    });
    ...
    $('#dnt_chn_price').on('change', function () {
        var $model = $(this).closest('tr').attr('id');
        var $spec = 0;
        if ($(this).prop("checked")) {
            $spec = 1;
