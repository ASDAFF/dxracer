...
echo "<table class='firts'>
	...
	<td>&nbsp;</td>
		...
		<td>
			<div class='filter'>
				<ul>
					<li><a class='button' href='/m/crm/?group=К прозвону'>К прозвону</a></li>
					<li><a class='button' href='/m/crm/?group=Резерв'>Резерв</a></li>
					<li><a class='button' href='/m/crm/?group=К сбору'>К сбору</a></li>
					<li><a class='button' href='/m/crm/?group=Собрано'>Собрано</a></li>
					<li><a class='button' href='/m/crm/?group=На доставке'>На доставке</a></li>
					<li><a class='button' href='/m/crm/?group=Доставлено'>Доставлено</a></li>
					<li><a class='button' href='/m/crm/?group=Отказ на доставке'>Отказ на доставке</a></li>
					<li><a class='button' href='/m/crm/?group=Выполнен'>Выполнен</a></li>
					<li><a class='button' href='/m/crm/?group=Отказ'>Отказ</a></li>
					<li><a class='button' href='/m/crm/?group=Проблема'>Проблема</a></li>
				</ul>
			</div>
		</td>
		<td>
