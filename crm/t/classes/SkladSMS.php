 ...
 * Спасибо за обращение в KingWatches.ru
 *
 * для СПСР от WT:
 *
 * Здравствуйте, Юрий.
...
Спасибо за заказ!";
    ...
    private function getBrandByArt($art)
    {
        ...
        if ($brand == 'Прочие бренды') { //получаем данные с сайта
            $c = mysql_connect(Configuration::MYSQL_SERVER, Configuration::MYSQL_USERNAME, Configuration::MYSQL_DB);
