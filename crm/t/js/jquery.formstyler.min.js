        ...
        return this.each(function () {
            ...
            if (a.is(":checkbox"))a.each(function () {
                if (1 > a.parent("div.jq-checkbox").length) {
                    var e = function () {
                        ...
                        b.attr("unselectable", "on").css({
                            ...
                            "-o-user-select": "none", "user-select": "none", display: "inline-block", position: "relative", overflow: "hidden"
                        });
                ...
                if (1 > a.parent("div.jq-radio").length) {
                    var s = function () {
                        var p = new A, b = c("<div" + p.id + ' class="jq-radio' + p.classes + '"' + p.title + '><div class="jq-radio__div"></div></div>');
                        a.css({position: "absolute", zIndex: "-1", opacity: 0, margin: 0, padding: 0}).after(b).prependTo(b);
                        b.attr("unselectable", "on").css({
                        ...
                        b.on("click.styler", function () {
                            b.is(".disabled") || (b.closest(e.wrapper).find('input[name="' + a.attr("name") + '"]').prop("checked",
                                !1).parent().removeClass("checked"), a.prop("checked", !0).parent().addClass("checked"), a.change());
                            return !1
                        });
                        a.closest("label").add('label[for="' + a.attr("id") + '"]').click(function (a) {
                            b.click();
                ...
                position: "absolute",
                top: 0, right: 0, width: "100%", height: "100%", opacity: 0, margin: 0, padding: 0
            }).each(function () {
                if (1 > a.parent("div.jq-file").length) {
                    var s = function () {
                        var p = new A, b = a.data("placeholder");
                        void 0 === b && (b = e.filePlaceholder);
                        var n = a.data("browse");
                        if (void 0 === n || "" === n)n = e.fileBrowse;
                        var d = c("<div" + p.id + ' class="jq-file' + p.classes + '"' + p.title + ' style="display: inline-block; position: relative; overflow: hidden"></div>'), g = c('<div class="jq-file__name">' + b + "</div>").appendTo(d);
                        c('<div class="jq-file__browse">' +
                        n + "</div>").appendTo(d);
                        a.after(d);
                        d.append(a);
                        ...
                        a.on("change.styler", function () {
                            var c = a.val();
                            if (a.is("[multiple]"))for (var c = "", e = a[0].files, p = 0; p < e.length; p++)c += (0 < p ? ", " : "") + e[p].name;
                            g.text(c.replace(/.+[\\\/]/, ""));
                    ...
                    var s = function () {
                        ...
                        function b() {
                            for (var a = 0, c = g.length; a < c; a++) {
                                ...
                                g.eq(a).parent().is("optgroup") && (void 0 !== g.eq(a).parent().attr("class") && (d = " " + g.eq(a).parent().attr("class")),
                                    b = "<li" + q + ' class="' + e + p + " option" + d + '">' + g.eq(a).html() + "</li>", g.eq(a).is(":first-child") && (b = '<li class="optgroup' + d + '">' + g.eq(a).parent().attr("label") + "</li>" + b));
                                s += b
                            }
                        }

                        function n() {
                            var d = new A, v = "", k = a.data("placeholder"), h = a.data("search"), n = a.data("search-limit"), w = a.data("search-not-found"), q = a.data("search-placeholder"), u = a.data("z-index"), t = a.data("smart-positioning");
                            ...
                            var E = c("div.jq-selectbox__select", f), z = c("div.jq-selectbox__select-text", f), d = g.filter(":selected");
                            b();
                            ...
                            f.append(l);
                            var r = c("ul", l), m = c("li", l), y = c("input", l), x = c("div.jq-selectbox__not-found", l).hide();
                            ...
                            "" === g.first().text() && "" !== a.data("placeholder") &&
                            m.first().hide();
                            a.css({position: "absolute", left: 0, top: 0, width: "100%", height: "100%", opacity: 0});
                            var G = f.outerHeight(), C = y.outerHeight(), D = r.css("max-height"), k = m.filter(".selected");
                            ...
                            l.hide();
                            k.length && (g.first().text() != d.text() && f.addClass("changed"), f.data("jqfs-class", k.data("jqfs-class")),
                                f.addClass(k.data("jqfs-class")));
                            ...
                            E.click(function () {
                                ...
                                if (!navigator.userAgent.match(/(iPad|iPhone|iPod)/i)) {
                                    var b = c(window), q = m.data("li-height"), d = f.offset().top, k = b.height() - G - (d - b.scrollTop()), h = a.data("visible-options");
                                    ...
                                    !0 === t || 1 === t ? k > v + C + 20 ? (h(), f.removeClass("dropup").addClass("dropdown")) :
                                        (s(), f.removeClass("dropdown").addClass("dropup")) : (!1 === t || 0 === t) && k > v + C + 20 && (h(), f.removeClass("dropup").addClass("dropdown"));
                                    c("div.jqselect").css({zIndex: u - 1}).removeClass("opened");
                                    f.css({zIndex: u});
                            ...
                            a.on("change.styler", function () {
                                ...
                                function () {
                                    ...
                                    13 == b.which &&
                                    (b.preventDefault(), l.hide(), f.removeClass("opened dropup dropdown"), e.onSelectClosed.call(f))
                                }).on("keydown.styler", function (a) {
                        ...
                        function d() {
                            ...
                            b();
                            d.append("<ul>" + s + "</ul>");
                            var k = c("ul", d).css({position: "relative", "overflow-x": "hidden", "-webkit-overflow-scrolling": "touch"}), h = c("li", d).attr("unselectable", "on").css({
                                    "-webkit-user-select": "none",
                                    "-moz-user-select": "none",
                                    "-ms-user-select": "none",
                                    "-o-user-select": "none",
                                ...
                                e = a.attr("size"), n = k.outerHeight(), w = h.outerHeight();
                            void 0 !== e && 0 < e ? k.css({height: w * e}) : k.css({height: 4 * w});
                            ...
                            if (a.is(":disabled"))d.addClass("disabled"), g.each(function () {
                                ...
                                40 != a.which &&
                                39 != a.which && 34 != a.which || k.scrollTop(k.scrollTop() + h.filter(".selected:last").position().top - k.innerHeight() + 2 * w)
                            })
                        }

                        var g = c("option", a), s = "";
                        if (a.is("[multiple]")) {
                            var x = navigator.userAgent.match(/Android/i) ? !0 : !1, I = navigator.userAgent.match(/(iPad|iPhone|iPod)/i) ? !0 : !1;
                            x || I || d()
                        } else n()
                    };
                    s();
