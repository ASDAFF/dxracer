...
if($action=='setSpecialofferMS'){
    echo $sk->setSpecialofferMS($model, $spec);
}
...
if($action=='dontChangePriceList'){
    $sk->dontChangePriceList($_POST);
}
...
if($action=='startHandUpdate'){
    exec('php -f /home/bitrix/www/crm/t/update_price/cron/start_update.php HandStart',$data);
    echo "<pre>";
    print_r($data);
    echo "</pre>";
}