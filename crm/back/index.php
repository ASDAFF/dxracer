...
//				$("#phone").mask("99999999999");
			...
			function sending(who) {
				...
				var url = 'https://time-avenue.com/api/GetByNameZakaz1234.php';
			...
			function insToBase(phone, name, adress, details, list) {
				$.ajax({
					url: 'https://crm.time-avenue.com/t/ajax/ins.php',
					type: "POST",
					data: {
						tip: 'insert',
						who: '<?=$_SESSION["wtORbv"]?>',
...
<!--		<tr>-->
<!--			<td>-->
<!--				<label for="WT"> KW</label><input id="WT" type="radio" name="radio" value="WT"-->
...
<!--		</tr>-->
		...
		<tr>
			<td colspan="2">
				<input type="button" value="Архив" onclick="location.href='/t/search/'" class="styler">
			</td>
		</tr>
	</table>
