...
//добавляем по одной позиции те, что если не добавятся
...

  {
    ...
    system('/usr/bin/mysqldump -u root -p3297650586time --opt --complete-insert zakaz1234 |  gzip > /home/bitrix/www/crm/t//sklad/close_sklad_sql/zakaz1234_`date +\%d-\%m-\%Y`.sql.gz');
