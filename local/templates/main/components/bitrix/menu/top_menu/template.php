  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbar-main">
     <ul class="nav navbar-nav">
        ...
        <li><a href="/catalog/"><span><img src='/local/templates/main/img/list.png'></span>&nbsp;&nbsp;&nbsp;&nbsp;КАТАЛОГ КРЕСЕЛ</a></li>
	<?/*
		<li ><a href="javascript:void(0);" data-toggle="dropdown"><span><img src='/local/templates/main/img/list.png'></span>&nbsp;&nbsp;&nbsp;&nbsp;КАТАЛОГ</a>
	...
	*/?>
        ...
        <li><a href="/catalog/sale.php">КРЕСЛА ПО АКЦИИ</a></li>
