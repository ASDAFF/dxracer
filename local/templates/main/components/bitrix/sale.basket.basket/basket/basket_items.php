...
<div class='basket-item-box' id='<?=$arItem["ID"]?>'>
	...
	<div id="basket_quantity_control"><br><br>
														<div class="basket_quantity_control">
															<p class="quality">Количество:</p>
															<div class="inputs">
															<a href="javascript:void(0);" class="minus" onclick="setQuantity(<?=$arItem["ID"]?>, 1, 'down', <?=$useFloatQuantityJS?>);"><i class="fa fa-minus" aria-hidden="true"></i></a>
																		<?
																		...
																		>
															<a href="javascript:void(0);" class="plus" onclick="setQuantity(<?=$arItem["ID"]?>, 1, 'up', <?=$useFloatQuantityJS?>);"><i class="fa fa-plus" aria-hidden="true"></i></a>
															</div>
														</div>
													</div>
	...
	<div class='col-xs-1 text-right'><br><br>
		<a class='js-delete-<?=$arItem["ID"]?> delete-item' href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"
...
<div class='summ-block '>
	<div class='sum-inf'>
			<p class="f-price">
				...
				<span class="right text-bold"   id="sum_FORMATED">
	...
	<p class="sum-price">
		...
		<span class="right text-red text-bold max-summ" id="allSum_FORMATED">
		<?=$arResult["allSum_FORMATED"]?>
		</span>
		<div class='clearfix'></div>
	</p>
