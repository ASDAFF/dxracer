			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
						<div class="col-xs-2 bx-filter-parameters-box bx-active">
							<span class="bx-filter-container-modef"></span>
							<div class="bx-filter-parameters-box-title" ><div class="row bx-filter-parameters-box-container">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="col-xs-2 bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
				...
				?>
				<div class='col-xs-1 bx-filter-parameters-box'><button class="btn btn-themes "
								type="submit"
								id="set_filter"
								name="set_filter"></button></div>
			


				<div class="col-xs-2 bx-filter-button-box">
