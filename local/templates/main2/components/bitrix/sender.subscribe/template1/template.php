...
?>
	...
	<form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" class='form-inline' action="<?=$arResult["FORM_ACTION"]?>">
		<?=bitrix_sessid_post()?>
		<input type="hidden" name="sender_subscription" value="add">

		<div class="bx-input-subscribe">
			<input class="form-control " type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="ВВЕДИТЕ СВОЙ E-MAIL">
			<button class="subscribe-btn" id="bx_subscribe_btn_<?=$buttonId?>">Подписаться<span><img src="/local/templates/main/img/arWhite.png"></span></button>
		</div>
