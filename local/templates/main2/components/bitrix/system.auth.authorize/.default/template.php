...
<?endif?>
			<tr>
				<td></td>
				<td class="authorize-submit-cell"><input type="submit" class="btn btn-main" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" /><a class='auth-link-ya' href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" rel="nofollow"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a></td>
			</tr>
		</table>
