...
<script>
                $(function(){
                     ...
                     yaCounter31208296.reachGoal('allforms');
                    yaCounter31208296.reachGoal('callback');
                 });
            </script>
<?else:?>
<?
...
<table class='bx-registration-table'>
...
<?
		...
		case "CONFIRM_PASSWORD":
			?><input size="30" type="password" class="bx-auth-input" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" /><?
			break;
...
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td><input type="submit" name="register_submit_button" class='btn btn-main' value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
