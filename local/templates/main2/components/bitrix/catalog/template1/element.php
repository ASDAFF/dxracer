...
?>
<div>
	<a href='/catalog/sale.php' style='background:url("/local/templates/main/img/detail_banner.png")no-repeat' class='detail_b_b'></a>
</div>
<br>
<div  id='bg-catalog-page'>
...
$arFilter = Array("IBLOCK_ID"=>1, "SECTION_ID"=>3, "ACTIVE"=>"Y");
$res = CIBlockElement::GetList(Array("CATALOG_QUANTITY"=>"desc"), $arFilter, false, Array("nTopCount"=>12), $arSelect);
while($ob = $res->Fetch())
{
 $arrH[] =$ob['ID'];
}
//echo "<pre>"; print_r($arrH); echo "</pre>";
$GLOBALS["newF"] = array('ID'=>$arrH);
?>
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PROPERTY_CODE" => array("OLD_PRICE",""),
		"PROPERTY_CODE_MOBILE" => array(0=>"OLD_PRICE",),
