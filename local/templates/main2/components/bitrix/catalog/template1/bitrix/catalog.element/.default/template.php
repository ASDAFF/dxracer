...
<div class="bx_item_slider" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
	...
	<div class='label-stic'>
		<?if(!empty($arResult['PROPERTIES']['HIT'])){?>
			<span><img src='/local/templates/main/img/best.png'></span>
		<?}
		?>
	</div>
...
<?if(!empty($arResult['PROPERTIES']['SALE']) ):?>
	<div class='label-stic1'>
		<?
		if(!empty($arResult['PROPERTIES']['SALE'])){?>
			<span><img src='/local/templates/main/img/sale.png'></span>
		<?}?>
	</div>
	<?//echo "<pre>"; print_r($arItem); echo "</pre>";?>
<?endif;?>
...
?>
		...
		<div class="bx_lb col-xs-12">
			<div class="el-name">
				...
				<div class='col-xs-5'>
					<?if($arResult['PROPERTIES']['PROP13']['VALUE_ENUM_ID']==38):?>
...
<span class='nostock'>Нет в наличии</span>
			...
			<div class="item_price">
					...
					<div class="item_current_price" id="<? echo $arItemIDs['PRICE']; ?>"><? echo $minPrice['DISCOUNT_VALUE']; ?> RUB</div>
					<div class='old-price-time'><?=$arResult['PRICES']['OLD_PRICE']['VALUE']?></div>
                    ...
                    ?>
					<p class='text_econom'>Вы экономите <?=$arResult['PRICES']['OLD_PRICE']['VALUE'] - $minPrice['DISCOUNT_VALUE']?> руб.(<?=$percent?>%) </p>
					<?
		...
		strtotime('09.02.2020 23:59:59'),
		strtotime('14.02.2020 23:59:59'),
		strtotime('19.02.2020 23:59:59'),
		strtotime('24.02.2020 23:59:59'),
		strtotime('29.02.2020 23:59:59'),
		strtotime('05.03.2020 23:59:59'),
		strtotime('08.03.2020 23:59:59'),
		strtotime('14.03.2020 23:59:59'),
		strtotime('19.03.2020 23:59:59'),
		strtotime('24.03.2020 23:59:59'),
		strtotime('29.03.2020 23:59:59'),
		strtotime('03.04.2020 23:59:59'),
		strtotime('07.04.2020 23:59:59'),
		strtotime('13.04.2020 23:59:59'),
		strtotime('18.04.2020 23:59:59'),
		strtotime('22.04.2020 23:59:59'),
		strtotime('27.04.2020 23:59:59'),
		strtotime('01.05.2020 23:59:59'),
					);
					$end_day = "";
	...
	break;
					...
					?>
					<p>Цена действует до:<br><span id="countDown" class='sale-detail-box'><?=$end_day?> <?=$arr[$month]?> <?=$end_y?> 23:59</span></p>
<?endif;?>
					<br>
					<?if($arResult['PROPERTIES']['PROP13']['VALUE_ENUM_ID']==38){?>
					<div class="item_buttons vam">
	<div class='item_buttons_counter_block' id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>">
	<a href="javascript:void(0);" class="footer-mail detail-button js-add" id="<? echo $arItemIDs['ADD_BASKET_LINK']; ?>">В корзину<span><img src="/local/templates/main/img/arWhite.png"></span></a><a href='#detailForm' data-toggle='modal' class='detailFormLink'>Нашли дешевле?</a>
					</div></div>
...
<br>
<div class='col-xs-6 detail-page'>
...
<li><a  data-toggle="tab" href="#panel3" class='border-no-right' style='border-right:none!important;'>Возврат без проблем</a></li>
</ul>
...
<ul>
	...
	<li>
		 Если невозможно использовать часы в течение гарантийного срока сроком более 30 дней (в совокупности) после их сервиса.
	</li>
	<li>
...
<p>
	 Для того чтобы вернуть часы необходимо следующее:
</p>
<ul>
	<li>
...
<div class='col-xs-6 detail_r_b'>
	<a href='/catalog/sale.php'><img src='/local/templates/main/img/detail_banner_2.png' class='img-responsive'></a>
