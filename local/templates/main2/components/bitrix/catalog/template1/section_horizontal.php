...
?>
<?if($arResult['VARIABLES']['SECTION_CODE']=="tissot"):?>
<div class="section-title-block" style='background:url("/local/templates/main/img/catalog_title.png")no-repeat;'>
	<div class='container'>
		<div class="col-xs-12 section-title-block-box">
...
<?else:?>
<div class="section-title-block-black">
	<div class='container'>
		<div class="col-xs-12 section-title-block-box">
			<h1><?$APPLICATION->ShowTitle(true)?></h1>
			 <?$APPLICATION->IncludeComponent("bitrix:breadcrumb", "template1", Array(
	...
	<?endif?>
		...
		<?$intSectionID = $APPLICATION->IncludeComponent(
			...
			array(
				...
				"BSER_TITLE" => $arParams["LIST_BSER_TITLE"],
