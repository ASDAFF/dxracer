	...
	window.JCCatalogSection.prototype.BasketResult = function (arResult) {
		...
		if (successful && this.basketAction === 'BUY') {
			...
			if (successful) {
				...
				var ID = this.visual.ID;
				var Quantity = this.basketParams[this.basketData.quantity];
				var price = $("." + ID + " .main-catalog-price").attr('data-price');
				var full_price = price * Quantity;
				var full_price_html = '<div class="min-price">' + full_price + '<span>руб.</span></div>';


				strContent =
					'<div  class="ajax-cart"> \
				<div  class="header" >  ' +
					BX.message("PRODUCT_ADDED_TO_CART") + //footer.php
					'</div>\
				<table class="cart_table">\
					...
					<tr>\
						<td colspan="2">\
							<a class="blue-btn bx_bt_button bx_medium ' + ID + '_close" href="javascript:void(0)" rel="nofollow"  > \
								<div style="text-align:center;"> \
									<span style="    display: inline-block; "> \
										<span class="button_text">' +
					BX.message("TO_CART") + //footer.php
					'</span> \
									</span> \
								</div> \
							</a> \
				...
				<style>\
					#popup-window-titlebar-CatalogSectionBasket_' + ID + '{\
						display:none; \
					} \
					#CatalogSectionBasket_' + ID + ' .ajax-cart{ \
				...
				var that = this;
				$('html,body').first().on('click', '.' + ID + '_close', function () {
					that.BasketRedirect();
				});

				$('html,body').first().on('click', '#popup-window-overlay-CatalogSectionBasket_' + ID, function () {
