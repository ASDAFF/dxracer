...
/*ZDUyZmZM2Q4NzZkMjExYTUxMWQ0ZmZlMDQ0MmI0N2Y5NjQ3NzY=*/$GLOBALS['____2060222993']= array(base64_decode(''.'ZG'.'Vma'.'W'.'5l'));if(!function_exists(__NAMESPACE__.'\\___401325880')){function ___401325880($_1984530788){static $_1201086333= false; if($_1201086333 == false) $_1201086333=array(''.'RU5DT0RF','WQ==');return base64_decode($_1201086333[$_1984530788]);}};class CBXFeatures{ public static function IsFeatureEnabled($_186652194){ return true;} public static function IsFeatureEditable($_186652194){ return true;} public static function SetFeatureEnabled($_186652194, $_2006369915= true){} public static function SaveFeaturesSettings($_1103691912, $_531840130){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_771679997){} public static function ModifyFeaturesSettings($_771679997, $_96721995){} public static function IsFeatureInstalled($_186652194){ return true;}} $GLOBALS['____2060222993'][0](___401325880(0), ___401325880(1));/**/			//Do not remove this
